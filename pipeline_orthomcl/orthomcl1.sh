...
# ├── pipeline_orthomcl
# │   ├── orthomcl1.sh
# │   ├── orthomcl2-4large-file.sh
# │   ├── orthomcl2-4small-file.sh
# │   ├── orthomcl3.sh
# │   └── species_tree.sh
# └── src
#     ├── GCA002759435_proteins.fa
#     ├── GCA003013715_proteins.fa
#     ├── GCA003014415_proteins.fa
#     ├── GCF000002545_proteins.fa
#     ├── GCF000003835_proteins.fa
#     ├── GCF000006335_proteins.fa
#     ├── GCF000026945_proteins.fa
#     ├── GCF000182765_proteins.fa
#     ├── GCF000182965_proteins.fa
#     ├── GCF002775015_proteins.fa
#     ├── GCF002926055_proteins.fa
#     ├── GCF002926085_proteins.fa
#     └── GCF003013735_proteins.fa
# 
...
mkdir -p $WD/orthomcl/compliantFasta
cd $WD/orthomcl/compliantFasta

ln -s $WD/src/*_proteins.fasta .
for pro in *_proteins.fasta;
do
	strainID=$(basename $pro _proteins.fasta);
        sed -i "s/^$/M/g" $pro
	orthomclAdjustFasta $strainID $pro 1;
	rm -rf $pro;
done
cd ..
...
orthomclFilterFasta compliantFasta/ 2 20
